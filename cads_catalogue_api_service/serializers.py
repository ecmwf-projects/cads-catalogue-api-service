...
class CollectionSerializer(Serializer):
    ...
    @classmethod
    def db_to_stac(cls, db_model: database.Resource, base_url: str) -> TypedDict:
    ...
    @classmethod
    def stac_to_db(cls, stac_data: TypedDict) -> database.Resource:
        """Transform stac collection to database model."""
        return database.Resource(**dict(stac_data))
